...
class ContrastiveLlamaTrainingArgument:
    ...
    base_model: Optional[str] = field(
        default='/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/yangxin106/models/yahna-llama-7b-hf/',
        metadata={"help": "Base model of Llama"}
    )
    lora_weights: Optional[str] = field(
        default="/mnt/dolphinfs/hdd_pool/docker/user/hadoop-mtai/users/yangxin106/models/tloen-alpaca-lora-7b",
        metadata={
...
def main():
    ...
    if contrastive_llama_args.use_contrastive_data:
        ...
        lora_config_args = contrastive_llama_args if contrastive_llama_args.resume_from_checkpoint is None else load_data_from_pkl(
